                    ...
                    <>
                        ...
                        <div className='w-full px-5'>
                            <form onSubmit={handleSubmit} aria-required={true}>
                                <div className="w-full 800px:flex block 800px:pb-3 pb-1">
...
const AllRefundOrders = () => {
    ...
    const eligibleOrders = orders && orders.filter((item) => item.status === "Procssing Refund")
...
const Address = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (addressType === '' || country === '' || city === "") {
            toast.error("Please fille all the fields")
        } else {
