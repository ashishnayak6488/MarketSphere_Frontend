        ...
        <div className='bg-white'>
            {
                data ? (
                    <div className={`${styles.section} w-[90%] 800px:w-[80%]`}>
                        ...
                        <ProductDetailsInfo data={data} products={products} totalReiewsLength={totalReiewsLength} averageRating={averageRating} />
                        <br />
                        <br />
...
const ProductDetailsInfo = ({ data, products, totalReiewsLength, averageRating }) => {
                        ...
                        <div className="w-full 800px:w-[50%] mt-5 800px:mt-0 800px:flex flex-col items-end">
                            <div className="text-left">
                                <h5 className='font-[600]'>
                                    Join on : <span className='font-[500]'>{data.shop?.createdAt?.slice(0, 10)}</span>
                                ...
                                <h5 className='font-[600] pt-3'>
                                    Total Reviews : <span className='font-[500]'>{totalReiewsLength}</span>
