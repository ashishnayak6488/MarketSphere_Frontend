...
const Header = ({ activeHeading }) => {
    ...
    return (
        ...
        <>
            ...
            <div className={`${active === true ? "shadow-sm fixed top-0 left-0 z-10" : null} transition hidden 800px:flex items-center justify-between w-full bg-[#332ac8] h-[70px]`}>
                                ...
                                <div className='flex w-full justify-center'>
                                    {
                                        isAuthenticated ? (
                                            ...
                                            <>
                                                <Link to='/login' className='text-[20px] pr-[10px] text-[#000000b7]'>Login /</Link>
                                                <Link to='/sign-up' className='text-[20px] pr-[10px] text-[#000000b7]'>Signup /</Link>
                                            </>
