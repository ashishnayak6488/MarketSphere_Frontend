...
const MessageList = ({ data, index, setOpen, me, setCurrentChat, setUserData, online, setActiveStatus, isLoading }) => {
    ...
    return (
        <div className={`w-full flex p-2 px-3 ${active === index ? "bg-[#00000010]" : "bg-transparent"} cursor-pointer`}
            onClick={(e) =>
                setActive(index) ||
            ...
            <div className="relative">
                ...
                />
                {
                    online ? (
                        ...
                        <div className='w-[8px] h-[8px] bg-[#aa9d9d] rounded-full absolute top-[2px] right-[2px]' />
...
const SellerInbox = ({ scrollRef, setOpen, newMessage, setNewMessage, sendMessageHandler, sellerId, userData, handleImageUpload, messages, activeStatus }) => {
    return (
