...
const Cart = ({ setOpenCart }) => {
    ...
    return (
        <div className='fixed top-0 left-0 w-full bg-[#0000004b] h-screen z-10 overflow-y-scroll'>
            <div className="absolute top-0 right-0 min-h-full w-[90%] 800px:w-[30%] bg-white flex flex-col justify-between shadow-sm">
                {
                    cart && cart.length === 0 ? (
                            ...
                            <div className="px-5 mb-3">
                                ...
                                <Link to={'/checkout'}>
                                    <div className={`h-[45px] flex items-center justify-center w-[100%] bg-[#e44343] rounded-[5px]`}>
                                        <h1 className='text-white text-[18px] font-[600]'>Checkout Now (USD${totalPrice})</h1>
        ...
        <div className="border-b p-4">
            <div className='w-full flex items-center'>
                ...
                <div className='pl-[5px]'>
                    ...
                    <h4 className='font-[600] text-[17px] text-[#d02222] font-Roboto'>US${totalPrice}</h4>
